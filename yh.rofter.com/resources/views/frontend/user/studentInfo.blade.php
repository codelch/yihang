    ...
    <form class="logon_form" name="" method="post" action="">
        ...
        <div class="logon_form_container">
            ...
            <div class="form_input_container">
                ...
                <div class="input-group">
                    <input type="radio" name="gender" checked value="1" />男&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="2" />女
                </div>
                <font color="red" class="form-warning"></font>
            </div>
            <div class="form_input_container">
        ...
        <div class="logon_form_container">
            ...
            <div class="form_input_container">
                <p class="form_text" style="color:#000;">目标院校<span style="color:red">*</span></p>
                <div class="input-group">
                    <input type="text" class="form-control" name="targetschool" placeholder="目标学校">
                </div>
                <font color="red" class="form-warning"></font>
            </div>
            <div class="form_input_container">
                <p class="form_text" style="color:#000;">目标专业<span style="color:red">*</span></p>
                <div class="input-group">
                    <input type="text" class="form-control" name="targetprofession" placeholder="目标专业">
                </div>
                <font color="red" class="form-warning"></font>
            </div>
            <div class="form_input_container">
...
@section('js')
    <script>
                ...
                $.ajax({
                    url : '{{url("doregister/student/info")}}',
                    data : send_data,
                    type : 'POST',
                    dataType : 'JSON',
                    beforeSend : function(){
                        ...
                        if (! send_data['targetschool']) {
                            $('input[name="targetschool"]').formWarning('目标学校不能为空!')
                            no_warning = false
                        }

                        if (! send_data['targetprofession']) {
                            $('input[name="targetprofession"]').formWarning('目标专业不能为空!')
                            no_warning = false
                        }
                    ...
                    if(data.code == 200){
                        window.location.href = '{{url("register/student/success")}}'
                    } else {
